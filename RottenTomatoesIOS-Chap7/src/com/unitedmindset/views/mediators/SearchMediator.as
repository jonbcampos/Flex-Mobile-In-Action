package com.unitedmindset.views.mediators
{
	...
	public class SearchMediator extends Mediator
	{
		...
		override public function onRegister():void
		{
			...
			view.searchButton.addEventListener(MouseEvent.CLICK, _onSearchButton_ClickHandler);
			...
			//
			eventDispatcher.addEventListener(ModelUpdateEvent.SEARCH_LIST_CHANGED, _onSystem_ListChangedHandler);
			eventDispatcher.addEventListener(ModelUpdateEvent.SEARCH_LOADING_CHANGED, _onSystem_LoadingChangedHandler);
		...
		override public function onRemove():void
		{
			...
			view.searchButton.removeEventListener(MouseEvent.CLICK, _onSearchButton_ClickHandler);
			...
			//
			eventDispatcher.removeEventListener(ModelUpdateEvent.SEARCH_LIST_CHANGED, _onSystem_ListChangedHandler);
			eventDispatcher.removeEventListener(ModelUpdateEvent.SEARCH_LOADING_CHANGED, _onSystem_LoadingChangedHandler);
		}
		...
		private var _adLocation:String = "http://unitedmindset.com/queuemanager/android/240dpi-adsense.html";
