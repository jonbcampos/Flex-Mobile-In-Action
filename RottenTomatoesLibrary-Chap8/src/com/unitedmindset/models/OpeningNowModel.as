package com.unitedmindset.models
{
	...
	public class OpeningNowModel extends Actor implements IListModel
	{
		//---------------------------------------------------------------------
		//
		//  Constructor
		//
		//---------------------------------------------------------------------
		public function OpeningNowModel()
		{
			super();
			_getPersistedData();
		}
		...
		//
		//---------------------------------------------------------------------
		private static const LIST:String = "openingNowList";
		private static const TIMESTAMP:String = "openingNowTimestamp";
		private static const CURRENT_PAGE:String = "openingNowCurrentPage";
		private static const TOTAL:String = "openingNowTotal";
		//---------------------------------------------------------------------
		//
		//  Private Properties
		//
		...
		{
			_loading = true;
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.OPENING_NOW_LOADING_CHANGED, _loading));
			
			_currentPage = page;
			dispatch(new RequestDataEvent(RequestDataEvent.OPENING_NOW_LIST, currentPage, numOfResults));
		}
		...
		public function setList(value:Array, total:int):void
		{
			...
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.OPENING_NOW_LIST_CHANGED, list));
		}
		...
		public function getFailed(fault:ServiceFault):void
		{
			...
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.OPENING_NOW_FAULT, fault));
		}
