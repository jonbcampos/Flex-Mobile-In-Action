package com.unitedmindset.views.mediators
{
	...
	public class TopRentalsMediator extends Mediator
	{
		//---------------------------------------------------------------------
		//
		//  Constructor
		//
		//---------------------------------------------------------------------
		public function TopRentalsMediator()
		{
			super();
		}
		...
		//---------------------------------------------------------------------
		[Inject]
		public var view:TopRentalsView;
		...
		override public function onRegister():void
		{
			...
			//
			eventDispatcher.addEventListener(ModelUpdateEvent.TOP_RENTALS_LIST_CHANGED, _onSystem_ListChangedHandler);
			eventDispatcher.addEventListener(ModelUpdateEvent.TOP_RENTALS_LOADING_CHANGED, _onSystem_LoadingChangedHandler);
		...
		override public function onRemove():void
		{
			...
			//
			eventDispatcher.removeEventListener(ModelUpdateEvent.TOP_RENTALS_LIST_CHANGED, _onSystem_ListChangedHandler);
			eventDispatcher.removeEventListener(ModelUpdateEvent.TOP_RENTALS_LOADING_CHANGED, _onSystem_LoadingChangedHandler);
		}
