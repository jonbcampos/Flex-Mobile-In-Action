package com.unitedmindset.views.mediators
{
	...
	public class BoxOfficeMediator extends Mediator
	{
		//---------------------------------------------------------------------
		//
		//  Contructor
		//
		//---------------------------------------------------------------------
		public function BoxOfficeMediator()
		{
			super();
		}
		...
		override public function onRegister():void
		{
			...
			//
			eventDispatcher.addEventListener(ModelUpdateEvent.BOX_OFFICE_LIST_CHANGED, _onSystem_ListChangedHandler);
			eventDispatcher.addEventListener(ModelUpdateEvent.BOX_OFFICE_LOADING_CHANGED, _onSystem_LoadingChangedHandler);
		...
		override public function onRemove():void
		{
			...
			//
			eventDispatcher.removeEventListener(ModelUpdateEvent.BOX_OFFICE_LIST_CHANGED, _onSystem_ListChangedHandler);
			eventDispatcher.removeEventListener(ModelUpdateEvent.BOX_OFFICE_LOADING_CHANGED, _onSystem_LoadingChangedHandler);
		}
