package com.unitedmindset.models
{
	...
	public class UpcomingDvdModel extends Actor implements IListModel
	{
		//---------------------------------------------------------------------
		//
		//  Constructor
		//
		//---------------------------------------------------------------------
		public function UpcomingDvdModel()
		{
			super();
			_getPersistedData();
		}
		...
		//
		//---------------------------------------------------------------------
		private static const LIST:String = "upcomingDvdList";
		private static const TIMESTAMP:String = "upcomingDvdTimestamp";
		private static const CURRENT_PAGE:String = "upcomingDvdCurrentPage";
		private static const TOTAL:String = "upcomingDvdTotal";
		//---------------------------------------------------------------------
		//
		//  Private Properties
		//
		...
		{
			_loading = true;
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.UPCOMING_DVD_LOADING_CHANGED, _loading));
			
			_currentPage = page;
			dispatch(new RequestDataEvent(RequestDataEvent.UPCOMING_DVD_LIST, currentPage, numOfResults));
		}
		...
		public function setList(value:Array, total:int):void
		{
			...
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.UPCOMING_DVD_LIST_CHANGED, list));
		}
		...
		public function getFailed(fault:ServiceFault):void
		{
			...
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.UPCOMING_DVD_FAULT, fault));
		}
