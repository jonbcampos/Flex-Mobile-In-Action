package com.unitedmindset.views.mediators
{
	...
	public class UpcomingDvdMediator extends Mediator
	{
		//---------------------------------------------------------------------
		//
		//  Constructor
		//
		//---------------------------------------------------------------------
		public function UpcomingDvdMediator()
		{
			super();
		}
		...
		//---------------------------------------------------------------------
		[Inject]
		public var view:UpcomingDvdView;
		...
		override public function onRegister():void
		{
			...
			//
			eventDispatcher.addEventListener(ModelUpdateEvent.UPCOMING_DVD_LIST_CHANGED, _onSystem_ListChangedHandler);
			eventDispatcher.addEventListener(ModelUpdateEvent.UPCOMING_DVD_LOADING_CHANGED, _onSystem_LoadingChangedHandler);
		...
		override public function onRemove():void
		{
			...
			//
			eventDispatcher.removeEventListener(ModelUpdateEvent.UPCOMING_DVD_LIST_CHANGED, _onSystem_ListChangedHandler);
			eventDispatcher.removeEventListener(ModelUpdateEvent.UPCOMING_DVD_LOADING_CHANGED, _onSystem_LoadingChangedHandler);
		}
