package com.unitedmindset.models
{
	...
	public class BoxOfficeModel extends Actor implements IListModel
	{
		//---------------------------------------------------------------------
		//
		//  Constructor
		//
		//---------------------------------------------------------------------
		public function BoxOfficeModel()
		{
			super();
			_getPersistedData();
		}
		...
		//
		//---------------------------------------------------------------------
		private static const LIST:String = "boxOfficeList";
		private static const TIMESTAMP:String = "boxOfficeTimestamp";
		private static const CURRENT_PAGE:String = "boxOfficeCurrentPage";
		private static const TOTAL:String = "boxOfficeTotal";
		//---------------------------------------------------------------------
		//
		//  Private Properties
		//
		...
		{
			_loading = true;
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.BOX_OFFICE_LOADING_CHANGED, _loading));
			
			_currentPage = page;
			dispatch(new RequestDataEvent(RequestDataEvent.BOX_OFFICE_LIST, currentPage, numOfResults));
		}
		...
		public function setList(value:Array, total:int):void
		{
			...
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.BOX_OFFICE_LIST_CHANGED, list));
		}
		...
		public function getFailed(fault:ServiceFault):void
		{
			...
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.BOX_OFFICE_FAULT, fault));
		}
