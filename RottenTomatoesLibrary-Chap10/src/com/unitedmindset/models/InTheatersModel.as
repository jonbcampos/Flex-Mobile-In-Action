package com.unitedmindset.models
{
	...
	public class InTheatersModel extends Actor implements IListModel
	{
		//---------------------------------------------------------------------
		//
		//  Constructor
		//
		//---------------------------------------------------------------------
		public function InTheatersModel()
		{
			super();
			_getPersistedData();
		}
		...
		//
		//---------------------------------------------------------------------
		private static const LIST:String = "inTheatersList";
		private static const TIMESTAMP:String = "inTheatersTimestamp";
		private static const CURRENT_PAGE:String = "inTheatersCurrentPage";
		private static const TOTAL:String = "inTheatersTotal";
		//---------------------------------------------------------------------
		//
		//  Private Properties
		//
		...
		{
			_loading = true;
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.IN_THEATER_LOADING_CHANGED, _loading));
			
			_currentPage = page;
			dispatch(new RequestDataEvent(RequestDataEvent.IN_THEATERS_LIST, currentPage, numOfResults));
		}
		...
		public function setList(value:Array, total:int):void
		{
			...
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.IN_THEATER_LIST_CHANGED, list));
		}
		...
		public function getFailed(fault:ServiceFault):void
		{
			...
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.IN_THEATER_FAULT, fault));
		}
