package com.unitedmindset.models
{
	...
	public class UpcomingTheatersModel extends Actor implements IListModel
	{
		//---------------------------------------------------------------------
		//
		//  Constructor
		//
		//---------------------------------------------------------------------
		public function UpcomingTheatersModel()
		{
			super();
			_getPersistedData();
		}
		...
		//
		//---------------------------------------------------------------------
		private static const LIST:String = "upcomingTheatersList";
		private static const TIMESTAMP:String = "upcomingTheatersTimestamp";
		private static const CURRENT_PAGE:String = "upcomingTheatersCurrentPage";
		private static const TOTAL:String = "upcomingTheatersTotal";
		//---------------------------------------------------------------------
		//
		//  Private Properties
		//
		...
		{
			_loading = true;
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.UPCOMING_THEATER_LOADING_CHANGED, _loading));
			
			_currentPage = page;
			dispatch(new RequestDataEvent(RequestDataEvent.UPCOMING_THEATER_LIST, currentPage, numOfResults));
		}
		...
		public function setList(value:Array, total:int):void
		{
			...
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.UPCOMING_THEATER_LIST_CHANGED, list));
		}
		...
		public function getFailed(fault:ServiceFault):void
		{
			...
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.UPCOMING_THEATER_FAULT, fault));
		}
