package com.unitedmindset.models
{
	...
	public class NewDvdModel extends Actor implements IListModel
	{
		//---------------------------------------------------------------------
		//
		//  Constructor
		...
		//
		//---------------------------------------------------------------------
		private static const LIST:String = "newDvdList";
		private static const TIMESTAMP:String = "newDvdTimestamp";
		private static const CURRENT_PAGE:String = "newDvdCurrentPage";
		private static const TOTAL:String = "newDvdTotal";
		//---------------------------------------------------------------------
		//
		//  Private Properties
		//
		...
		{
			_loading = true;
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.NEW_DVD_LOADING_CHANGED, _loading));
			
			_currentPage = page;
			dispatch(new RequestDataEvent(RequestDataEvent.NEW_DVD_LIST, currentPage, numOfResults));
		}
		...
		public function setList(value:Array, total:int):void
		{
			...
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.NEW_DVD_LIST_CHANGED, list));
		}
		...
		public function getFailed(fault:ServiceFault):void
		{
			...
			dispatch(new ModelUpdateEvent(ModelUpdateEvent.NEW_DVD_FAULT, fault));
		}
