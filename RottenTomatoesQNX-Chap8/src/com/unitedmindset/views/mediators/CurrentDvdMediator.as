package com.unitedmindset.views.mediators
{
	...
	public class CurrentDvdMediator extends Mediator
	{
		//---------------------------------------------------------------------
		//
		//  Constructor
		//
		//---------------------------------------------------------------------
		public function CurrentDvdMediator()
		{
			super();
		}
		...
		//---------------------------------------------------------------------
		[Inject]
		public var view:CurrentDvdView;
		...
		override public function onRegister():void
		{
			...
			//
			eventDispatcher.addEventListener(ModelUpdateEvent.CURRENT_DVD_LIST_CHANGED, _onSystem_ListChangedHandler);
			eventDispatcher.addEventListener(ModelUpdateEvent.CURRENT_DVD_LOADING_CHANGED, _onSystem_LoadingChangedHandler);
		...
		override public function onRemove():void
		{
			...
			//
			eventDispatcher.removeEventListener(ModelUpdateEvent.CURRENT_DVD_LIST_CHANGED, _onSystem_ListChangedHandler);
			eventDispatcher.removeEventListener(ModelUpdateEvent.CURRENT_DVD_LOADING_CHANGED, _onSystem_LoadingChangedHandler);
		}
