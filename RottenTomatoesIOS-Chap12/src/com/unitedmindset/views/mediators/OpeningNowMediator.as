package com.unitedmindset.views.mediators
{
	...
	public class OpeningNowMediator extends Mediator
	{
		//---------------------------------------------------------------------
		//
		//  Constructor
		//
		//---------------------------------------------------------------------
		public function OpeningNowMediator()
		{
			super();
		}
		...
		//---------------------------------------------------------------------
		[Inject]
		public var view:OpeningNowView;
		...
		override public function onRegister():void
		{
			...
			//
			eventDispatcher.addEventListener(ModelUpdateEvent.OPENING_NOW_LIST_CHANGED, _onSystem_ListChangedHandler);
			eventDispatcher.addEventListener(ModelUpdateEvent.OPENING_NOW_LOADING_CHANGED, _onSystem_LoadingChangedHandler);
		...
		override public function onRemove():void
		{
			...
			//
			eventDispatcher.removeEventListener(ModelUpdateEvent.OPENING_NOW_LIST_CHANGED, _onSystem_ListChangedHandler);
			eventDispatcher.removeEventListener(ModelUpdateEvent.OPENING_NOW_LOADING_CHANGED, _onSystem_LoadingChangedHandler);
		}
